  ...
  Widget getStarsWidget(rate) {
    ...
    for (var i = 0; i < 5; i++) {
      if (i < rate)
        ...
        list.add(
          new Image.asset("assets/icons/star.png", height: 19),
        );
      if (i < 4)
        list.add(
          new SizedBox(
            ...
            child: Container(
              ...
              child: Padding(
                padding: const EdgeInsets.only(
                    top: 16, bottom: 16, left: 66, right: 67),
                child: Column(
                  children: [
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [Text("Оцените курьера", style: TxtStyle.H1)],
                    ),
                    Spacer(flex: 40),
                    Column(
                      mainAxisAlignment: MainAxisAlignment.center,
